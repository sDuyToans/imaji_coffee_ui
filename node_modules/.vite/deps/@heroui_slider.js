...
function useTooltip(originalProps) {
  ...
  const tooltipId = (0, import_react6.useId)();
  ...
  const getTriggerProps = (0, import_react7.useCallback)(
    (props2 = {}, _ref = null) => ({
  ...
  const getTooltipContentProps = (0, import_react7.useCallback)(
    () => ({
      "data-slot": "content",
      "data-open": dataAttr(isOpen),
      "data-arrow": dataAttr(showArrow),
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger;
  try {
    const childrenNum = import_react8.Children.count(children);
    ...
    if (!(0, import_react8.isValidElement)(children)) {
      ...
      trigger = (0, import_react8.cloneElement)(child, getTriggerProps(child.props, childRef));
    }
  } catch {
...
// node_modules/@heroui/slider/node_modules/@react-aria/visually-hidden/dist/VisuallyHidden.mjs
...
function $5c3e21d68f1c4674$export$439d29a4e110a164(props) {
  ...
  return (0, import_react9.default).createElement(Element, (0, $3ef42575df84b30b$export$9d1611c77c2fe928)(otherProps, visuallyHiddenProps), children);
}
...
var SliderThumb = forwardRef((props, ref) => {
  ...
  const thumbProps = {
    ...getThumbProps(),
    index,
    children: (0, import_jsx_runtime2.jsx)($5c3e21d68f1c4674$export$439d29a4e110a164, { children: (0, import_jsx_runtime2.jsx)("input", { ...getInputProps() }) })
  };
  ...
  return showTooltip ? (0, import_jsx_runtime2.jsx)(tooltip_default, { ...getTooltipProps(), children: content }) : content;
});
...
function $28f99e3e86e6ec45$export$e5fda3247f5d67f9(props) {
  ...
  let pageSize = (0, import_react10.useMemo)(() => {
  ...
  let restrictValues = (0, import_react10.useCallback)((values2) => values2 === null || values2 === void 0 ? void 0 : values2.map((val, idx) => {
  ...
  let value = (0, import_react10.useMemo)(() => restrictValues($28f99e3e86e6ec45$var$convertValue(props.value)), [
    props.value,
    restrictValues
  ]);
  let defaultValue = (0, import_react10.useMemo)(() => {
    var _convertValue;
  ...
  let [initialValues] = (0, import_react10.useState)(values);
  const [isDraggings, setDraggingsState] = (0, import_react10.useState)(new Array(values.length).fill(false));
  const isEditablesRef = (0, import_react10.useRef)(new Array(values.length).fill(true));
  const [focusedIndex, setFocusedIndex] = (0, import_react10.useState)(void 0);
  const valuesRef = (0, import_react10.useRef)(values);
  const isDraggingsRef = (0, import_react10.useRef)(isDraggings);
...
function useSlider(originalProps) {
  ...
  const clampValue = (0, import_react11.useCallback)(
    (valueToClamp) => {
      return Math.min(Math.max(valueToClamp, minValue), maxValue);
    },
    [minValue, maxValue]
  );
  const validatedValue = (0, import_react11.useMemo)(() => {
...
var Slider = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Component, { ...getBaseProps(), children: [
    label && (0, import_jsx_runtime3.jsxs)("div", { ...getLabelWrapperProps(), children: [
      renderFn({
        Component: "label",
        props: getLabelProps(),
    ...
    (0, import_jsx_runtime3.jsxs)("div", { ...getTrackWrapperProps(), children: [
      startContent && (0, import_jsx_runtime3.jsx)("div", { ...getStartContentProps(), children: startContent }),
      (0, import_jsx_runtime3.jsxs)("div", { ...getTrackProps(), children: [
        (0, import_jsx_runtime3.jsx)("div", { ...getFillerProps() }),
        Number.isFinite(steps) && Array.from({ length: steps }, (_, index) => (0, import_jsx_runtime3.jsx)("div", { ...getStepProps(index) }, index)),
        state.values.map((_, index) => (0, import_jsx_runtime3.jsx)(slider_thumb_default, { ...getThumbProps(index) }, index)),
        (marks == null ? void 0 : marks.length) > 0 && marks.map((mark, index) => (0, import_jsx_runtime3.jsx)("div", { ...getMarkProps(mark), children: mark.label }, index))
      ] }),
      endContent && (0, import_jsx_runtime3.jsx)("div", { ...getEndContentProps(), children: endContent })
    ] })
  ] });
});
...
//# sourceMappingURL=@heroui_slider.js.map
