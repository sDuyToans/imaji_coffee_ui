...
} from "./chunk-XZ6HXC4N.js";
import {
  $40df3f8667284809$export$d55e7ee900f34e93
} from "./chunk-GREQRJBI.js";
import {
  $fc909762b330b746$export$61c6a8c84e605fb6,
  useAriaOverlay
} from "./chunk-XHQXXAQ5.js";
import {
  TRANSITION_VARIANTS
} from "./chunk-VIMUOXQG.js";
import "./chunk-OO3AOAZY.js";
import {
  button_default
} from "./chunk-WK6RQZRN.js";
import {
  spinner_default
} from "./chunk-HBUEEYDX.js";
import "./chunk-HBNQ5XD7.js";
import {
  useAriaButton
} from "./chunk-25DTL2RO.js";
import {
  useSafeLayoutEffect
} from "./chunk-K76PRZ77.js";
import {
  $e5be200c675c3b3a$export$fc1a364ae1f3ff10,
  $e93e671b31057976$export$b8473d3665f3a75a,
  FormContext,
  useSlottedContext
} from "./chunk-6UAV7WFK.js";
import {
  $2baaea4c71418dea$export$294aa081a6c6f55d,
  $d191a55c9702f145$export$8467354a121f1b9f
} from "./chunk-5UJYTW75.js";
import {
  forwardRef as forwardRef2
} from "./chunk-C4GIZK7U.js";
import {
  ChevronDownIcon,
  CloseFilledIcon
} from "./chunk-PNMP7YBZ.js";
import {
  forwardRef,
  mapPropsVariants,
  useLabelPlacement,
  useProviderContext
} from "./chunk-4FD6ETZU.js";
import {
...
function useMultiSelectListState(props) {
  ...
  const missingKeys = (0, import_react3.useMemo)(() => {
...
function $a28c903ee9ad8dc5$export$79fefeb1c2091ac3(props) {
  ...
  let [focusStrategy, setFocusStrategy] = (0, import_react4.useState)(null);
  let [expandedKeysStack, setExpandedKeysStack] = (0, import_react4.useState)([]);
  let closeAll = () => {
...
function useMultiSelectState({
  ...
  const [isFocused, setFocused] = (0, import_react6.useState)(false);
  const [focusStrategy, setFocusStrategy] = (0, import_react6.useState)(null);
...
function useMultiSelect(props, state, ref) {
  ...
  const delegate = (0, import_react10.useMemo)(
...
function useSelect(originalProps) {
  ...
  const getHiddenSelectProps = (0, import_react11.useCallback)(
    (props2 = {}) => ({
      state,
      triggerRef,
      selectRef: domRef,
  ...
  const getValueProps = (0, import_react11.useCallback)(
    (props2 = {}) => ({
      "data-slot": "value",
  ...
  const getListboxWrapperProps = (0, import_react11.useCallback)(
    (props2 = {}) => ({
  ...
  const getPopoverProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      var _a2, _b2;
  ...
  const getSelectorIconProps = (0, import_react11.useCallback)(
    () => ({
  ...
  const getHelperWrapperProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getDescriptionProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        ...descriptionProps,
  ...
  const getMainWrapperProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndWrapperProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getEndContentProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
  ...
  const getSpinnerProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        "aria-hidden": dataAttr(true),
        "data-slot": "spinner",
  ...
  const getClearButtonProps = (0, import_react11.useCallback)(
    (props2 = {}) => {
      return {
        ...props2,
        type: "button",
...
var useLayoutEffect = typeof document !== "undefined" ? import_react12.default.useLayoutEffect : () => {
};
...
function useFormReset(ref, initialValue, onReset) {
  let resetValue = (0, import_react12.useRef)(initialValue);
...
function $5c3e21d68f1c4674$export$439d29a4e110a164(props) {
  ...
  return (0, import_react13.default).createElement(Element, (0, $3ef42575df84b30b$export$9d1611c77c2fe928)(otherProps, visuallyHiddenProps), children);
}
...
function useListbox(props) {
  ...
  const slots = (0, import_react14.useMemo)(() => menu(), []);
  const baseStyles = clsx(classNames == null ? void 0 : classNames.base, className);
...
function useListboxItem(originalProps) {
  ...
  const disableAnimation = (_b = (_a = originalProps.disableAnimation) != null ? _a : globalContext == null ? void 0 : globalContext.disableAnimation) != null ? _b : false;
  const domRef = (0, import_react15.useRef)(null);
  ...
  const getSelectedIconProps = (0, import_react15.useCallback)(
    (props2 = {}) => {
      return {
        "aria-hidden": dataAttr(true),
        "data-disabled": dataAttr(isDisabled),
...
var ListboxItem = (props) => {
  ...
  const selectedContent = (0, import_react16.useMemo)(() => {
...
var Divider = forwardRef2((props, ref) => {
...
function useDataScrollOverflow(props = {}) {
  ...
  const visibleRef = (0, import_react20.useRef)(visibility);
...
var VirtualizedListbox = (props) => {
  ...
  const itemSizes = (0, import_react19.useMemo)(
  ...
  const [scrollState, setScrollState] = (0, import_react19.useState)({
    isTop: false,
    isBottom: true,
    isMiddle: false
  });
...
function usePopover(originalProps) {
  ...
  const Component = as || "div";
  const domRef = useDOMRef(ref);
  const domTriggerRef = (0, import_react23.useRef)(null);
  const wasTriggerPressedRef = (0, import_react23.useRef)(false);
  ...
  const placement = (0, import_react23.useMemo)(() => {
    if (!ariaPlacement) {
      return null;
    }
  ...
  const onPress = (0, import_react23.useCallback)(
    (e) => {
      var _a2;
      let pressTimer;
  ...
  const getTriggerProps = (0, import_react23.useCallback)(
    (props2 = {}, _ref = null) => {
...
var domAnimation = () => import("./dist-TEZSEI5P.js").then((res) => res.default);
...
var domAnimation2 = () => import("./dist-TEZSEI5P.js").then((res) => res.default);
var PopoverContent = (props) => {
  ...
  const backdropContent = (0, import_react24.useMemo)(() => {
    if (backdrop === "transparent") {
      return null;
    }
    if (disableAnimation) {
...
var PopoverTrigger = (props) => {
  ...
  const child = (0, import_react25.useMemo)(() => {
    if (typeof children === "string") return (0, import_jsx_runtime10.jsx)("p", { children });
    return import_react25.Children.only(children);
  }, [children]);
  const childRef = (_a = child.props.ref) != null ? _a : child.ref;
  const { onPress, isDisabled, ...restProps } = (0, import_react25.useMemo)(() => {
  ...
  const hasHeroUIButton = (0, import_react25.useMemo)(() => {
...
function useDataScrollOverflow2(props = {}) {
  ...
  const visibleRef = (0, import_react27.useRef)(visibility);
...
var Select = forwardRef(function Select2(props, ref) {
  ...
  const clonedIcon = (0, import_react30.cloneElement)(selectorIcon, getSelectorIconProps());
  const clearButton = (0, import_react29.useMemo)(() => {
    var _a2;
  ...
  const end = (0, import_react29.useMemo)(() => {
    if (clearButton) {
  ...
  const helperWrapper = (0, import_react29.useMemo)(() => {
  ...
  const renderSelectedItem = (0, import_react29.useMemo)(() => {
    var _a2;
