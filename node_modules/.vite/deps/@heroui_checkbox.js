...
} from "./chunk-6SYJYCZR.js";
import {
  $3017fa7ffdddec74$export$8042c6c013fd5226
} from "./chunk-MKJJPC56.js";
import {
...
function useCheckbox(props = {}) {
  ...
  const labelId = (0, import_react5.useId)();
  const ariaCheckboxProps = (0, import_react6.useMemo)(
    () => ({
      name,
      value,
      children,
  ...
  const getLabelProps = (0, import_react5.useCallback)(
    () => ({
      id: labelId,
      className: slots.label({ class: classNames == null ? void 0 : classNames.label })
    }),
...
var Checkbox = forwardRef((props, ref) => {
  ...
  const clonedIcon = typeof icon === "function" ? icon(getIconProps()) : (0, import_react7.cloneElement)(icon, getIconProps());
