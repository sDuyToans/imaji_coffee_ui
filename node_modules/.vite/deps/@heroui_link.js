...
var LinkIcon2 = (props) => (0, import_jsx_runtime41.jsxs)(
  "svg",
  {
    "aria-hidden": "true",
    fill: "none",
    ...
    ...props,
    children: [
      (0, import_jsx_runtime41.jsx)("path", { d: "M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6" }),
      (0, import_jsx_runtime41.jsx)("path", { d: "M15 3h6v6" }),
      (0, import_jsx_runtime41.jsx)("path", { d: "M10 14L21 3" })
    ]
  }
);
...
var Link = forwardRef((props, ref) => {
  const {
    ...
    children,
    showAnchorIcon,
    anchorIcon = (0, import_jsx_runtime68.jsx)(LinkIcon2, { className: linkAnchorClasses }),
    getLinkProps
  } = useLink({
    ref,
    ...props
  });
  return (0, import_jsx_runtime68.jsx)(Component, { ...getLinkProps(), children: (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [
    children,
