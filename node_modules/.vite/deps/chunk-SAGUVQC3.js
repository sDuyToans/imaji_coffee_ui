...
function useDisclosure(props = {}) {
  ...
  const onOpen = (0, import_react7.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    onOpenPropCallbackRef == null ? void 0 : onOpenPropCallbackRef();
  }, [isControlled, onOpenPropCallbackRef]);
  const onOpenChange = (0, import_react7.useCallback)(() => {
...
function useDraggable(props) {
  ...
  const boundary = (0, import_react8.useRef)({ minLeft: 0, minTop: 0, maxLeft: 0, maxTop: 0 });
  const isDragging = (0, import_react8.useRef)(false);
  let transform = { offsetX: 0, offsetY: 0 };
  const onMoveStart = (0, import_react8.useCallback)(() => {
    var _a, _b, _c, _d, _e;
  ...
  const onMove = (0, import_react8.useCallback)(
    (e) => {
      if (isDisabled) {
        return;
      }
  ...
  const onMoveEnd = (0, import_react8.useCallback)(() => {
  ...
  const preventDefault = (0, import_react8.useCallback)((e) => {
...
//# sourceMappingURL=chunk-SAGUVQC3.js.map
